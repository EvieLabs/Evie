  ...
  async execute(message, interaction) {
    ...
    if (msg === "encry") {
      message.channel.send(
        "https://cdn.discordapp.com/attachments/885135206435151872/899242373714948126/unknown.png"
      );
    }
    ...
    if (
      msg.includes("531656855433379848") ||
      ...
      if (
        auth.includes(`531656855433379848`) ||
      ...
      try {
        message.reply(
          `<:appleflushed:853840463638691840> Hey ${message.author.username}! Please don't tag our staff directly. (they will come to you!)`
        );
      } catch (error) {
        console.error(error);
      }
