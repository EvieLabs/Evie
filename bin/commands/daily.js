...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        if (result.error)
            exampleEmbed.setTitle(`Woof! ${interaction.user.username} You have already used your daily for today! You can do it again in ${result.time}`);
        else
            exampleEmbed.setTitle(`Woof! ${interaction.user.username} You just earned your daily $EVIE which was <:eviecoin:900886713096888371> 15,000.`);
