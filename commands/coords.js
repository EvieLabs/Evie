...
module.exports = {
	...
	async execute(interaction) {
		...
		exampleEmbed.addField('Hey, ' + interaction.user.username.toString() + ' want your landmark added to this command?', 'If so directly contact Tristan with the command `/dmtristan <message>` in <#877795126615879750>');
