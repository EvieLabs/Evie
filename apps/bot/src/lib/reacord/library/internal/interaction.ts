...
export type ButtonInteraction = BaseComponentInteraction<"button", ButtonClickEvent>;

export type SelectInteraction = BaseComponentInteraction<"select", SelectChangeEvent>;
...
export type BaseComponentInteraction<Type extends string, Event extends ComponentEvent> = BaseInteraction<Type> & {
	event: Event;
	customId: string;
