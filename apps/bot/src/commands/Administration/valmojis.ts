...
export class ValMojis extends Command {
	private readonly tiers = [
		{
			...
			smallIcon: "https://media.valorant-api.com/competitivetiers/e4e9a692-288f-63ca-7835-16fbf6234fda/3/smallicon.png",
			largeIcon: "https://media.valorant-api.com/competitivetiers/e4e9a692-288f-63ca-7835-16fbf6234fda/3/largeicon.png",
		...
		},
		{
			...
			color: "4f514fff",
			backgroundColor: "828282ff",
			smallIcon: "https://media.valorant-api.com/competitivetiers/e4e9a692-288f-63ca-7835-16fbf6234fda/4/smallicon.png",
			largeIcon: "https://media.valorant-api.com/competitivetiers/e4e9a692-288f-63ca-7835-16fbf6234fda/4/largeicon.png",
			rankTriangleDownIcon:
		...
		},
		{
			...
			color: "4f514fff",
			backgroundColor: "828282ff",
			smallIcon: "https://media.valorant-api.com/competitivetiers/e4e9a692-288f-63ca-7835-16fbf6234fda/5/smallicon.png",
			largeIcon: "https://media.valorant-api.com/competitivetiers/e4e9a692-288f-63ca-7835-16fbf6234fda/5/largeicon.png",
			rankTriangleDownIcon:
		...
		},
		{
			...
			smallIcon: "https://media.valorant-api.com/competitivetiers/e4e9a692-288f-63ca-7835-16fbf6234fda/6/smallicon.png",
			largeIcon: "https://media.valorant-api.com/competitivetiers/e4e9a692-288f-63ca-7835-16fbf6234fda/6/largeicon.png",
			rankTriangleDownIcon:
		...
		},
		{
			...
			color: "a5855dff",
			backgroundColor: "7c5522ff",
			smallIcon: "https://media.valorant-api.com/competitivetiers/e4e9a692-288f-63ca-7835-16fbf6234fda/7/smallicon.png",
			largeIcon: "https://media.valorant-api.com/competitivetiers/e4e9a692-288f-63ca-7835-16fbf6234fda/7/largeicon.png",
			rankTriangleDownIcon:
		...
		},
		{
			...
			color: "a5855dff",
			backgroundColor: "7c5522ff",
			smallIcon: "https://media.valorant-api.com/competitivetiers/e4e9a692-288f-63ca-7835-16fbf6234fda/8/smallicon.png",
			largeIcon: "https://media.valorant-api.com/competitivetiers/e4e9a692-288f-63ca-7835-16fbf6234fda/8/largeicon.png",
			rankTriangleDownIcon:
		...
		},
		{
			...
			smallIcon: "https://media.valorant-api.com/competitivetiers/e4e9a692-288f-63ca-7835-16fbf6234fda/9/smallicon.png",
			largeIcon: "https://media.valorant-api.com/competitivetiers/e4e9a692-288f-63ca-7835-16fbf6234fda/9/largeicon.png",
			rankTriangleDownIcon:
	...
	public override async messageRun(message: Message) {
		...
		const promises = this.tiers.map(async (tier) => {
			const image = await axios.get<Buffer>(tier.largeIcon, {
				responseType: "arraybuffer",
			});
			const buffer = Buffer.from(image.data);
			const formattedTierName = tier.tierName.toLowerCase().replace(/\s/g, "_");
			await guild.emojis.create(buffer, formattedTierName);
		});

		await Promise.all(promises);

		return void (await message.reply("Done!"));
	}
}
