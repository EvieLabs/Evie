...
export default function ValorantStatsComponent(props: { user: User; account: AccountData }) {
		...
		<>
			...
			{account ? (
				<>
					<>
						{component ? undefined : (
							<Select user={user} placeholder="Select stats..." value={value} onChangeValue={setValue}>
								<Option
						...
						<Button
							...
							onClick={() => {
								...
								switch (value) {
									case "info":
										setComponent(<ValorantUserInfo user={props.user} accountData={account} />);
										break;
									case "comp":
										setComponent(<ValorantCompStats user={props.user} accountData={account} />);
										break;
									case "game":
										setComponent(<ValorantGameStats user={props.user} accountData={account} />);
										break;
								}
							}}
						/>
