...
export function EmbedFooter(props: EmbedFooterProps) {
	return <ReacordElement props={props} createNode={() => new EmbedFooterNode(props)} />;
}
...
class EmbedFooterNode extends EmbedChildNode<EmbedFooterProps> {
	override modifyEmbedOptions(options: EmbedOptions): void {
		...
		options.timestamp = this.props.timestamp ? new Date(this.props.timestamp).toISOString() : undefined;
	}
}
